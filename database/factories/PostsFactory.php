...
$factory->define(Post::class, function (Faker $faker) {
    return [
        'admin_id' => '1',
        'title' => 'Cacao and Coffea - the Differences and Similarities of Chocolate and Coffee',
        'content' => '<h1>Cacao and Coffea - the Differences and Similarities of Chocolate and Coffee</h1>
